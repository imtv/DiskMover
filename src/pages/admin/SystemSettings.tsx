...
export default function SystemSettings() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white mb-2">系统设置</h1>
        <p className="text-sm sm:text-base text-zinc-400">配置管理员账号与全局功能开关</p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-4 sm:space-y-6">
        ...
        <div className="flex justify-center sm:justify-end">
          <button
            type="submit"
            disabled={isSaving}
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
